# final version: by example shows how took 'injects' current time
#   in this teaching script, the 'injection' is done by
#       adding to the prompt template when the ReAct 'thinking'
#       is stopped after 'Observation
...
llm = ChatOpenAI(model="gpt-4", stop=["\nObservation"])
...
Action Input: '%Y-%m-%d %H:%M:%S'""" + "\nObservation: '2025-02-16 09:53:00'" + "\nThought:"
